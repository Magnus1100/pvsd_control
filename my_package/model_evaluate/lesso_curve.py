...
path_lesso = '/.venv/sDGP_model/lesso-V2-0513.keras'
path_lesso2= 'D:\pythonProject\pythonProject\.venv\model(kFold)/lasso(kFold)-V1-0513.pkl'

# 加载模型
model = joblib.load(path_lesso2)

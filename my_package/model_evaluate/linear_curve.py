...
path_linear = '/.venv/sDGP_model\linear_regression_model.pkl'
path_linear2 = r'D:\pythonProject\pythonProject\.venv\my_package\models\sDGP_model/linear(kFold)-V2.pkl'

# 加载模型
model = joblib.load(path_linear2)
